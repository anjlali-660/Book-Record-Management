...
def userLogin(request):
    ...
    if request.method=='POST':
        ...
        if user:
            ...
            return HttpResponseRedirect('http://localhost:2000/brm/view-books/')
...
@login_required(login_url='http://localhost:2000/brm/login/')
def userLogout(request):
    logout(request)

    return HttpResponseRedirect('http://localhost:2000/brm/login/')
...
def addBook(request):
    if request.method=='POST':
        ...
        msg="Records cannot be saved in database"

    msg=msg+'<br> <a href="http://localhost:2000/brm/view-books/"> View Books </a>'
